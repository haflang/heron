...
proc create_root_design { parentCell } {
  ...
  set fifo_rx [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 fifo_rx ]
  set_property -dict [ list \
  ...
  # Create instance: fifo_tx, and set properties
  set fifo_tx [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 fifo_tx ]
  set_property -dict [ list \
  ...
  # Create instance: mpsoc_ps, and set properties
  set mpsoc_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.4 mpsoc_ps ]
  set_property -dict [ list \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  # Create instance: xlconst_high, and set properties
  set xlconst_high [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconst_high ]

  # Create instance: xlconst_pad, and set properties
  set xlconst_pad [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconst_pad ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {13} \
 ] $xlconst_pad

  # Create instance: xlslice_addr, and set properties
  set xlslice_addr [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_addr ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {10} \
   CONFIG.DIN_TO {1} \
  ...
  # Create instance: xlslice_go, and set properties
  set xlslice_go [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_go ]
  set_property -dict [ list \
   CONFIG.DIN_WIDTH {512} \
 ] $xlslice_go

  # Create instance: xlslice_tmpl, and set properties
  set xlslice_tmpl [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_tmpl ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {341} \
   CONFIG.DIN_TO {11} \
   CONFIG.DIN_WIDTH {512} \
   CONFIG.DOUT_WIDTH {331} \
 ] $xlslice_tmpl

  # Create interface connections
  connect_bd_intf_net -intf_net dma_rx_M_AXI_S2MM [get_bd_intf_pins dma_rx/M_AXI_S2MM] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net dma_tx_M_AXIS_MM2S [get_bd_intf_pins dma_tx/M_AXIS_MM2S] [get_bd_intf_pins fifo_tx/S_AXIS]
  connect_bd_intf_net -intf_net dma_tx_M_AXI_MM2S [get_bd_intf_pins dma_tx/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net fifio_rx_M_AXIS [get_bd_intf_pins dma_rx/S_AXIS_S2MM] [get_bd_intf_pins fifo_rx/M_AXIS]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins dma_rx/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins dma_tx/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins gpio_reset/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins mpsoc_ps/S_AXI_HP0_FPD] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins mpsoc_ps/M_AXI_HPM0_FPD] [get_bd_intf_pins ps8_0_axi_periph/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins dma_rx/s2mm_introut] [get_bd_pins mpsoc_ps/pl_ps_irq0]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins gpio_reset/gpio_io_o] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins fifo_tx/m_axis_tdata] [get_bd_pins xlslice_addr/Din] [get_bd_pins xlslice_go/Din] [get_bd_pins xlslice_tmpl/Din]
  connect_bd_net -net axis_data_fifo_0_m_axis_tvalid [get_bd_pins fifo_tx/m_axis_tvalid] [get_bd_pins heron/codeWE]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins fifo_rx/s_axis_aclk] [get_bd_pins fifo_tx/m_axis_aclk] [get_bd_pins heron/clk] [get_bd_pins mpsoc_ps/pl_clk1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net heron_ret [get_bd_pins heron/ret] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net heron_retVld [get_bd_pins fifo_rx/s_axis_tlast] [get_bd_pins fifo_rx/s_axis_tvalid] [get_bd_pins heron/retVld]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins fifo_rx/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins heron/rst] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins dma_rx/axi_resetn] [get_bd_pins dma_tx/axi_resetn] [get_bd_pins fifo_tx/s_axis_aresetn] [get_bd_pins gpio_reset/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins fifo_rx/s_axis_tdata] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconst_high_dout [get_bd_pins fifo_tx/m_axis_tready] [get_bd_pins heron/en] [get_bd_pins xlconst_high/dout]
  connect_bd_net -net xlconst_pad_dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconst_pad/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins heron/codeAddr] [get_bd_pins xlslice_addr/Dout]
  connect_bd_net -net xlslice_0_Dout1 [get_bd_pins heron/go] [get_bd_pins xlslice_go/Dout]
  connect_bd_net -net xlslice_tmpl_Dout [get_bd_pins heron/codeData] [get_bd_pins xlslice_tmpl/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins dma_rx/m_axi_s2mm_aclk] [get_bd_pins dma_rx/s_axi_lite_aclk] [get_bd_pins dma_tx/m_axi_mm2s_aclk] [get_bd_pins dma_tx/s_axi_lite_aclk] [get_bd_pins fifo_rx/m_axis_aclk] [get_bd_pins fifo_tx/s_axis_aclk] [get_bd_pins gpio_reset/s_axi_aclk] [get_bd_pins mpsoc_ps/maxihpm0_fpd_aclk] [get_bd_pins mpsoc_ps/pl_clk0] [get_bd_pins mpsoc_ps/saxihp0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins mpsoc_ps/pl_resetn0] [get_bd_pins rst_ps8_0_100M/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dma_rx/Data_S2MM] [get_bd_addr_segs mpsoc_ps/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dma_tx/Data_MM2S] [get_bd_addr_segs mpsoc_ps/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ps/Data] [get_bd_addr_segs dma_rx/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ps/Data] [get_bd_addr_segs dma_tx/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ps/Data] [get_bd_addr_segs gpio_reset/S_AXI/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dma_rx/Data_S2MM] [get_bd_addr_segs mpsoc_ps/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dma_tx/Data_MM2S] [get_bd_addr_segs mpsoc_ps/SAXIGP2/HP0_LPS_OCM]
